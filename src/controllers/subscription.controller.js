...
const getUserChannelSubscribers = asyncHandler(async (req, res) => {
  ...
  return res
    .status(200)
    .json(new ApiResponse(200, subscribers, "get subscribers to channel successfully"));
});
...
const getSubscribedChannels = asyncHandler(async (req, res) => {
  ...
  return res
    .status(200)
    .json(new ApiResponse(200, subscribed, "get channels list subscriber successfully"));
});
